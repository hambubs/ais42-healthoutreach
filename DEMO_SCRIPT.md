...
| 0:50 | Console | Click ⚡ Find Optimal Clinic Locations (fleet 3) | "Three mobile medical units. DBSCAN finds settlement clusters, greedy MCLP places the units for maximum area coverage — watch the coverage chip: 13.8% to 22.8% of villages under scheduled care. That's 14.75 million people." |
...
| 3:50 | Dashboard | Tab 2: Bengaluru pilot area | "Our Karnataka pilot view — real population density around the Bengaluru outskirts with the government facility directory overlaid." |
| 4:10 | Dashboard | Tab 3: Health data (live) | "This chart is fetched live from the DHS Program API right now — child anemia, 68.1% in the latest NFHS round." |
