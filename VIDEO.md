...
## Setup
- Windows: `Win + G` (Xbox Game Bar) → record, or OBS if installed; 720p minimum
- Quiet room, decent mic (phone earbuds work)
...
- The ESP32 rig: phone in airplane mode → portal → one-tap SOS → hub pull → sync → console pops

## Save & distribute
- `deck/demo_backup.mp4` (+ `deck/esp32_rig.mp4` if recorded)
- Copy to the **USB stick** AND **Google Drive** tonight — not tomorrow morning
